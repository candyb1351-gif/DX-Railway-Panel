      ...
      },
      {
        ...
        children: (
          <>
            ...
            <SettingListItem
              ...
              description={(
                <>
                  ...
                  <a
                    href="https://github.com/MHSanaei/DX/blob/main/docs/custom-subscription-templates.md"
                    target="_blank"
            ...
            >
              <Input value={allSetting.subThemeDir} placeholder="/etc/DX/sub_templates/my-theme/"
