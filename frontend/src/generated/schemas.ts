...
export const SCHEMAS: Record<string, unknown> = {
  "AllSetting": {
    "description": "AllSetting contains all configuration settings for the DX panel including web server, Telegram bot, and subscription settings.",
    "properties": {
      "datepicker": {
  ...
  "Node": {
    "description": "Node represents a remote DX panel registered with the central panel.\nThe central panel polls each node's existing /panel/api/server/status\nendpoint over HTTP using the per-node ApiToken to populate the runtime\nstatus fields below.",
    "properties": {
      "address": {
  ...
  "Setting": {
    "description": "Setting stores key-value configuration settings for the DX panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
  ...
  "User": {
    "description": "User represents a user account in the DX panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
