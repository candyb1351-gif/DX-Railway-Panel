// Package web provides the main web server implementation for the DX panel,
...
import (
	...
	"github.com/mhsanaei/DX/v3/internal/mtproto"
	"github.com/mhsanaei/DX/v3/internal/util/common"
	"github.com/mhsanaei/DX/v3/internal/web/controller"
	"github.com/mhsanaei/DX/v3/internal/web/job"
	"github.com/mhsanaei/DX/v3/internal/web/locale"
	"github.com/mhsanaei/DX/v3/internal/web/middleware"
	"github.com/mhsanaei/DX/v3/internal/web/network"
	"github.com/mhsanaei/DX/v3/internal/web/runtime"
	...
	"github.com/mhsanaei/DX/v3/internal/web/websocket"
...
// Server represents the main web server for the DX panel with controllers, services, and scheduled jobs.
type Server struct {
	httpServer *http.Server
	listener   net.Listener

	index *controller.IndexController
	panel *controller.DXController
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("DX", store))
	...
	s.panel = controller.NewDXController(g)
