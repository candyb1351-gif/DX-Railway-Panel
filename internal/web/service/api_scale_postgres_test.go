...
func TestAllAPIsPostgresScale(t *testing.T) {
	if strings.TrimSpace(os.Getenv("DX_DB_DSN")) == "" || os.Getenv("DX_DB_TYPE") != "postgres" {
		t.Skip("set DX_DB_TYPE=postgres and DX_DB_DSN to run the postgres scale benchmark")
	}
