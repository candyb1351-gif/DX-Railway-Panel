...
import (
	...
	"github.com/mhsanaei/DX/v3/internal/web/entity"
	"github.com/mhsanaei/DX/v3/internal/web/middleware"
	"github.com/mhsanaei/DX/v3/internal/web/session"

	"github.com/gin-gonic/gin"
)

// DXController is the main controller for the DX panel, serving the SPA shell.
type DXController struct {
	BaseController
}

// NewDXController creates a new DXController and initializes its routes.
func NewDXController(g *gin.RouterGroup) *DXController {
	a := &DXController{}
	a.initRouter(g)
	return a
}
...
func (a *DXController) initRouter(g *gin.RouterGroup) {
	g = g.Group("/panel")
	g.Use(a.checkLogin)
...
func (a *DXController) panelSPA(c *gin.Context) {
...
func (a *DXController) csrfToken(c *gin.Context) {
