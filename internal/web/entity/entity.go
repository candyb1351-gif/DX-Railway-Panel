// Package entity defines data structures and entities used by the web layer of the DX panel.
package entity
...
// AllSetting contains all configuration settings for the DX panel including web server, Telegram bot, and subscription settings.
...
func (s *AllSetting) CheckValid() error {
	...
	if s.WebPort <= 0 || s.WebPort > math.MaDXnt16 {
		return common.NewError("web port is not a valid port:", s.WebPort)
	}

	if s.SubPort <= 0 || s.SubPort > math.MaDXnt16 {
