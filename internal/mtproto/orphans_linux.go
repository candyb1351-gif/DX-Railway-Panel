...
// previous DX run and returns how many were killed.
//
// DX starts one mtg process per mtproto inbound outside its own lifecycle, and
...
// domain-fronted to the FakeTLS domain instead of proxied to Telegram. DX is
