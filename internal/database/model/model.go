// Package model defines the database models and data structures used by the DX panel.
package model
...
import (
	...
	"github.com/mhsanaei/DX/v3/internal/util/json_util"
...
// User represents a user account in the DX panel.
type User struct {
...
// Setting stores key-value configuration settings for the DX panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote DX panel registered with the central panel.
