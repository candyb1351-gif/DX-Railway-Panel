// Package main is the entry point for the DX web panel application.
...
import (
	...
	"github.com/mhsanaei/DX/v3/internal/config"
	"github.com/mhsanaei/DX/v3/internal/database"
	"github.com/mhsanaei/DX/v3/internal/logger"
	"github.com/mhsanaei/DX/v3/internal/sub"
	"github.com/mhsanaei/DX/v3/internal/util/crypto"
	"github.com/mhsanaei/DX/v3/internal/util/sys"
	"github.com/mhsanaei/DX/v3/internal/web"
	"github.com/mhsanaei/DX/v3/internal/web/global"
	"github.com/mhsanaei/DX/v3/internal/web/service"
	"github.com/mhsanaei/DX/v3/internal/web/service/panel"
	"github.com/mhsanaei/DX/v3/internal/web/service/tgbot"

	"github.com/joho/godotenv"
	"github.com/op/go-logging"
)

// runWebServer initializes and starts the web server for the DX panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the DX panel.
func migrateDb() {
...
// "DX setting" hit the same database backend as the panel. godotenv.Load does
...
// main is the entry point of the DX application.
...
func main() {
	...
	migrateDbCmd.StringVar(&migrateSrc, "src", "", "Source SQLite file (defaults to the configured DX.db)")
	...
	flag.Usage = func() {
		...
		fmt.Println("    migrate        migrate form other/old DX")
